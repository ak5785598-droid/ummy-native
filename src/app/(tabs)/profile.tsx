...
export default function ProfileScreen() {
  ...
  useEffect(() => {
    const onBackPress = () => {
      if (fullViewOpen) { setFullViewOpen(false); return true; }
      if (medalModalOpen) { setMedalModalOpen(false); return true; }
      if (socialOpen) { setSocialOpen(false); return true; }
      if (officialCenterOpen) { setOfficialCenterOpen(false); return true; }
      return false;
    };
