...
import { View, TextInput, TouchableOpacity, Text, Modal, KeyboardAvoidingView, Platform, StyleSheet, ScrollView, Keyboard, ViewStyle, TextStyle, ImageStyle } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  textInput: TextStyle;
  langBadgeBtn: ViewStyle;
  langBadgeText: TextStyle;
  sendBtn: ViewStyle;
  langPickerArea: ViewStyle;
  pickerHeader: ViewStyle;
  pickerTitle: TextStyle;
  pickerDone: TextStyle;
  pickerScroll: ViewStyle;
  langItemBtn: ViewStyle;
  langItemText: TextStyle;
};
