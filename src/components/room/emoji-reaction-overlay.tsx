...
export function EmojiReactionOverlay({ emoji, customEmojiUrl, size = 28, visible, onComplete, noAnimation, zoom = 1.2, offsetX = 0 }: EmojiReactionOverlayProps) {
  ...
  return (
    <Animated.View
      style={{
        ...
        transform: noAnimation ? [] : [{ scale }, { translateY: floatY }, { rotate: rotateInterp }, { translateX: shakeX }],
        opacity,
        zIndex: 100,
      }}
      pointerEvents="none"
