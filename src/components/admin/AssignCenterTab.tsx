      ...
      {targetUser && (
        <View style={{ marginTop: 8 }}>
          ...
          <View style={{ gap: 16, marginBottom: 40 }}>
            {/* Seller Center */}
            <View style={{ backgroundColor: '#fdf8f6', borderRadius: 24, borderWidth: 1.5, borderColor: '#ffedd5', padding: 20 }}>
            ...
            {/* Official Center */}
            <View style={{ backgroundColor: '#f5f3ff', borderRadius: 24, borderWidth: 1.5, borderColor: '#e0e7ff', padding: 20 }}>
