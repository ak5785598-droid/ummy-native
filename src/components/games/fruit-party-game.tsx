...
const ANIMALS = [
  { id: 'watermelon', emoji: '🍉', multiplier: 5,  label: 'x5',  color: '#10b981' },
  { id: 'grapes',     emoji: '🍇', multiplier: 5,  label: 'x5',  color: '#ec4899' },
  { id: 'orange',     emoji: '🍊', multiplier: 5,  label: 'x5',  color: '#f59e0b' },
  { id: 'lemon',      emoji: '🍋', multiplier: 5,  label: 'x5',  color: '#8b5cf6' },
  { id: 'strawberry', emoji: '🍓', multiplier: 10, label: 'x10', color: '#f97316' },
  { id: 'peach',      emoji: '🍑', multiplier: 15, label: 'x15', color: '#84cc16' },
  { id: 'cherry',     emoji: '🍒', multiplier: 25, label: 'x25', color: '#ef4444' },
  { id: 'banana',     emoji: '🍌', multiplier: 45, label: 'x45', color: '#eab308' },
];
...
export function FruitPartyGame({ onClose, roomId, onRoundEnd, isMuted }: FruitPartyGameProps) {
  ...
  const [history, setHistory] = useState<string[]>(['watermelon', 'banana', 'strawberry', 'peach', 'cherry']);
