...
async function uploadV3() {
  const localPath = 'D:\\Ummy_Dev_Live\\ummy-native\\emoji_thinking_top.gif';
  const remotePath = 'store/emoji_thinking_crop_v3.gif';

  console.log('Uploading v3 (top-cropped)...');
